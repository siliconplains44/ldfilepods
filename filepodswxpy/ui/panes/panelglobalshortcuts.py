...
###########################################################################
## Class PanelGlobalShortcuts
###########################################################################

class PanelGlobalShortcuts(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(1007, 448),
        ...
        self.m_gridData.SetColLabelValue(2, u"Shortcut Name")
    ...
    def LoadDataGrid(self):
        ...
        if self.m_checkBoxShowFileShortcuts.GetValue() == True:
            ...
            podFileShortcuts = businessLogic.RetrieveAllPodFileShortcutsBySecurityUserID(self.mainWindow.loggedInSecurityUserID, 1, None)['podfileshortcuts']
        ...
        if self.m_checkBoxShowFolderShortcuts.GetValue() == True:
            ...
            podFolderShortcuts = businessLogic.RetrieveAllPodFolderShortcutsBySecurityUserID(self.mainWindow.loggedInSecurityUserID, 1, None)['podfoldershortcuts']
