...
###########################################################################
## Class DialogModifyShortcut
###########################################################################

class DialogModifyShortcut(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Modify Shortcut", pos=wx.DefaultPosition,
        ...
        self.m_staticText39 = wx.StaticText(self, wx.ID_ANY, u"New Shortcut Name", wx.DefaultPosition, wx.DefaultSize,
                                            0)
