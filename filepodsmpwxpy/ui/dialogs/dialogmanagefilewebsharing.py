...
###########################################################################
## Class DialogManageFileWebSharing
###########################################################################

class DialogManageFileWebSharing(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Manage File Web Sharing", pos=wx.DefaultPosition,
                           size=wx.Size(834, 399), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        bSizer1331.AddSpacer((160, 0), 1, wx.EXPAND, 5)

        self.m_checkBoxAlwaysShareHighestRevision = wx.CheckBox(self, wx.ID_ANY,
                                                                u"Always Share Highest Revision Of This File",
                                                                wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer1331.Add(self.m_checkBoxAlwaysShareHighestRevision, 0, wx.ALL, 5)

        bSizer1331.AddSpacer((540, 0), 1, wx.EXPAND, 5)
        ...
        self.m_staticText39 = wx.StaticText(self, wx.ID_ANY, u"Identifier", wx.DefaultPosition, wx.Size(100, -1), 0)
        self.m_staticText39.Wrap(-1)
        bSizer133.Add(self.m_staticText39, 0, wx.ALL, 5)

        self.m_textCtrlIdentifer = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(600, -1), 0)
        bSizer133.Add(self.m_textCtrlIdentifer, 0, wx.ALL, 5)
        ...
        self.m_staticText401 = wx.StaticText(self, wx.ID_ANY, u"Description", wx.DefaultPosition, wx.Size(100, -1), 0)
