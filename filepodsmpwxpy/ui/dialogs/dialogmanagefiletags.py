...
class DialogManageFolderTags(wx.Dialog):
    ...
    def Initialize(self, podFileId, securityUserId):
        self.podFileId = podFileId
    ...
    def LoadDataGrid(self):
        ...
        tags = businessLogic.RetrieveTagsByOwnerSecurityUserIDAndObject(3, self.podFileId, self.securityUserId)['tags']
    ...
    def OnButtonClickAddTag(self, event):
        ...
        if result == 1:
            ...
            if DialogTagChooser.m_radioBtnAddFromExistingTags.GetValue() == True:
                businessLogic.AddTag(3, self.podFileId, DialogTagChooser.m_gridData.GetCellValue(DialogTagChooser.m_gridData.GetSelectedRows()[0], 1),
                                     self.securityUserId)
            else:
                businessLogic.AddTag(3, self.podFileId,
