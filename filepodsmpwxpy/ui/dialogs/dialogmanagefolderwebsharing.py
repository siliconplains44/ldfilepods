...
###########################################################################
## Class DialogManageFolderWebSharing
###########################################################################

class DialogManageFolderWebSharing(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Manage Folder Web Sharing", pos=wx.DefaultPosition,
                           size=wx.Size(751, 387), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.m_textCtrlIdentifer1 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(600, -1),
                                                wx.TE_PASSWORD )
        bSizer1331.Add(self.m_textCtrlIdentifer1, 0, wx.ALL, 5)
