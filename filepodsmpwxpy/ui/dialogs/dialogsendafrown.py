...
###########################################################################
## Class DialogSendaFrown
###########################################################################

class DialogSendaFrown(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Send a Frown", pos=wx.DefaultPosition,
        ...
        self.m_staticText12 = wx.StaticText(self, wx.ID_ANY,
                                            u"We appreciate your feedback.  Is there something we can do better?",
        ...
        self.m_textCtrlFeedback = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(500, 85),
        ...
        self.m_textCtrlEmailAddress = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(300, -1), 0)
        ...
        self.m_staticText13 = wx.StaticText(self, wx.ID_ANY,
                                            ...
                                            wx.DefaultPosition, wx.Size(500, 85), 0)
        ...
        self.m_buttonSendaFrown = wx.Button(self, wx.ID_ANY, u"Send a Frown", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer31.Add(self.m_buttonSendaFrown, 0, wx.ALIGN_CENTER, 5)
        ...
        self.m_buttonSendaFrown.Bind(wx.EVT_BUTTON, self.OnButtonSendaFrown)
    ...
    def OnButtonSendaFrown(self, event):
        self.EndModal(1);
